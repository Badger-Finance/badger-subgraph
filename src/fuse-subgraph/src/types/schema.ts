...
export class AdminFusePool extends Entity {
  ...
  save(): void {
    ...
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type AdminFusePool must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
  ...
  static load(id: string): AdminFusePool | null {
    return changetype<AdminFusePool | null>(store.get("AdminFusePool", id));
  }
...
export class AdminFusePoolTransaction extends Entity {
  ...
  save(): void {
    ...
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type AdminFusePoolTransaction must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
  ...
  static load(id: string): AdminFusePoolTransaction | null {
    return changetype<AdminFusePoolTransaction | null>(
      store.get("AdminFusePoolTransaction", id)
    );
  }
