...
export class AdminRightsRenounced extends ethereum.Event {
  get params(): AdminRightsRenounced__Params {
    return new AdminRightsRenounced__Params(this);
  }
}

export class AdminRightsRenounced__Params {
  _event: AdminRightsRenounced;

  constructor(event: AdminRightsRenounced) {
    this._event = event;
  }
}
...
export class FuseAdminRightsRenounced extends ethereum.Event {
  get params(): FuseAdminRightsRenounced__Params {
    return new FuseAdminRightsRenounced__Params(this);
  }
}

export class FuseAdminRightsRenounced__Params {
  _event: FuseAdminRightsRenounced;

  constructor(event: FuseAdminRightsRenounced) {
    this._event = event;
  }
}
...
export class CToken extends ethereum.SmartContract {
  ...
  _renounceAdminRights(): BigInt {
    let result = super.call(
      "_renounceAdminRights",
      "_renounceAdminRights():(uint256)",
      []
    );
  ...
  try__renounceAdminRights(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "_renounceAdminRights",
      "_renounceAdminRights():(uint256)",
      []
  ...
  _renounceFuseAdminRights(): BigInt {
    let result = super.call(
      "_renounceFuseAdminRights",
      "_renounceFuseAdminRights():(uint256)",
      []
    );
  ...
  try__renounceFuseAdminRights(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "_renounceFuseAdminRights",
      "_renounceFuseAdminRights():(uint256)",
      []
  ...
  _setFuseFee(): BigInt {
    let result = super.call("_setFuseFee", "_setFuseFee():(uint256)", []);

    return result[0].toBigInt();
  }

  try__setFuseFee(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("_setFuseFee", "_setFuseFee():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
...
export class _renounceAdminRightsCall extends ethereum.Call {
  get inputs(): _renounceAdminRightsCall__Inputs {
    return new _renounceAdminRightsCall__Inputs(this);
  }

  get outputs(): _renounceAdminRightsCall__Outputs {
    return new _renounceAdminRightsCall__Outputs(this);
  }
}

export class _renounceAdminRightsCall__Inputs {
  _call: _renounceAdminRightsCall;

  constructor(call: _renounceAdminRightsCall) {
    this._call = call;
  }
}

export class _renounceAdminRightsCall__Outputs {
  _call: _renounceAdminRightsCall;
...
export class _renounceFuseAdminRightsCall extends ethereum.Call {
  get inputs(): _renounceFuseAdminRightsCall__Inputs {
    return new _renounceFuseAdminRightsCall__Inputs(this);
  }

  get outputs(): _renounceFuseAdminRightsCall__Outputs {
    return new _renounceFuseAdminRightsCall__Outputs(this);
  }
}

export class _renounceFuseAdminRightsCall__Inputs {
  _call: _renounceFuseAdminRightsCall;

  constructor(call: _renounceFuseAdminRightsCall) {
    this._call = call;
  }
}

export class _renounceFuseAdminRightsCall__Outputs {
  _call: _renounceFuseAdminRightsCall;
...
export class _setFuseFeeCall extends ethereum.Call {
  get inputs(): _setFuseFeeCall__Inputs {
    return new _setFuseFeeCall__Inputs(this);
  }

  get outputs(): _setFuseFeeCall__Outputs {
    return new _setFuseFeeCall__Outputs(this);
  }
}

export class _setFuseFeeCall__Inputs {
  _call: _setFuseFeeCall;

  constructor(call: _setFuseFeeCall) {
    this._call = call;
  }
}

export class _setFuseFeeCall__Outputs {
  _call: _setFuseFeeCall;
